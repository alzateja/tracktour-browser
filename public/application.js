...
/***/ (function(module, exports, __webpack_require__) {
	...
	var wishlist = __webpack_require__(11);
	var artist = __webpack_require__(35);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://tracktour.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var wishlistEvents = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetWishes = function onGetWishes() {
	  store.wishlists = null;
	  api.getWishes().then(ui.getWishesSuccess).catch(ui.Failure);
	};
	...
	var onCreateWish = function onCreateWish(event) {
	  event.preventDefault();
	  $('.alert').hide();
	  var artistId = $('#selected-artist-id-wishlist').text();
	  ...
	  var inputStatus = $('#wishlist-status-select').text();
	  var data = {};
	  data.wishlist = {};
	  data.wishlist.wish_status = inputStatus;
	  data.wishlist.artist_id = artistId;

	  for (var i = 0; i < store.wishlists.length; i++) {
	  ...
	  api.createWish(data).then(ui.createWishSuccess).then(resetAddWishList).then(onGetWishes).catch(ui.Failure);
	};
	...
	var onDeleteWish = function onDeleteWish(event) {
	  ...
	  api.deleteWish(id).then(ui.deleteWishSuccess).then(onGetWishes).catch(ui.failure);
	};

	// Modify Goal
	var toggleWishStatus = function toggleWishStatus(event) {
	  event.preventDefault();
	  $('.alert').hide();
	  var id = $(event.target).parents('tr').attr('data-id');
	  var currentStatus = $('#status-' + id).text();
	  var data = {};
	  data.wishlist = {};
	  data.wishlist.id = id;
	  ...
	  // console.log(data)
	  api.updateWish(data).then(ui.updateWishSucess).then(onGetWishes).catch(ui.failure);
	};

	// Render button based on dropdown select
	var wishStatusSetState = function wishStatusSetState(event) {
	  event.preventDefault();
	  $('#wishlist-status-select').text(event.currentTarget.text);
	};

	var resetAddWishList = function resetAddWishList() {
	  $('.alert').hide();
	...
	module.exports = {
	  ...
	  wishStatusSetState: wishStatusSetState,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateWish = function updateWish(data) {
	  return $.ajax({
	    method: 'PATCH',
	    beforeSend: function beforeSend() {
	      $('loader').show();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var showWishes = __webpack_require__(14);
	...
	var updateWishSucess = function updateWishSucess(data) {
	  store.wishlists = null;
	};

	var deleteWishSuccess = function deleteWishSuccess() {
	...
	module.exports = {
	  ...
	  failure: failure,
	  updateWishSucess: updateWishSucess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n//// console.log(wish)\n<tr data-id="
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "'>"
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.artist : stack1)) != null ? stack1.artist_name : stack1), depth0))
	    + "</td>\n  <td id='status-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.wish_status : stack1), depth0))
	  ...
	  return "\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.wishlists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	);var onSelectArtists = function onSelectArtists() {
	  $('.artist-selection-list').empty();
	  $('.artist-select-space').show();

	  api.getArtists().then(ui.getArtistsSuccess).catch(ui.Failure);
	};

	// On Create Goal
	var onSelectArtist = function onSelectArtist(event) {
	  event.preventDefault();
	  $('.alert').hide
	  // console.log($('#add-artist-name').val())

	  ();var selected = $('input[name="selected-artist"]:checked').val();
	  var selectedId = $('input[name="selected-artist"]:checked').data('id');
	...
	var addNewArtist = function addNewArtist() {
	  // Clean Data Input
	  var input = $('#add-artist-name').val();
	  ...
	  for (var i = 0; i < store.artists.length; i++) {
	  ...
	  api.addArtists(data).then(ui.addArtistSuccess).catch(ui.Failure);
	};
	...
	module.exports = {
	  onSelectArtists: onSelectArtists,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// POST request to the API to create a goal for the current user
	var addArtists = function addArtists(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/artists',
	    method: 'POST',
	    beforeSend: function beforeSend() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var showArtists = __webpack_require__(38);

	var getArtistsSuccess = function getArtistsSuccess(data) {
	...
	var addArtistSuccess = function addArtistSuccess(data) {
	...
	var setArtistOnCreateWishlist = function setArtistOnCreateWishlist(artist, id) {
	  $('#selected-artist-wishlist').text(artist);
	  $('#selected-artist-id-wishlist').text(id);
	  $('.artist-select-space').hide();
	};

	var cancelSetArtist = function cancelSetArtist(artist) {
	  $('.artist-select-space').hide();
	  $('#add-artist-name').val('');
	  $('.alert').hide();
	};
	...
	module.exports = {
	  setArtistOnCreateWishlist: setArtistOnCreateWishlist,
	  getArtistsSuccess: getArtistsSuccess,
	  addArtistSuccess: addArtistSuccess,
	  cancelSetArtist: cancelSetArtist,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<span class=\"select-space\"><input class=\"artist-radio\" type=\"radio\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " name=\"selected-artist\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artist_name : stack1), depth0))
	    + "\" >"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artist_name : stack1), depth0))
	    + "</input></span>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.artists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
